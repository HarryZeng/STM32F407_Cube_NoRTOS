...
#define ENCODER2_PPR           (uint16_t)(4096)  // 电机2码盘线数
#define ENCODER1_PPR           (uint16_t)(4096)  // 电机2码盘线数

#define ICx_FILTER      (uint8_t) 6 // 6<-> 670nsec   编码器模式设置参数

#define SPEED_SAMPLING_FREQ (uint16_t)(2000/(SPEED_SAMPLING_TIME+1))  //200hz，小车速度采样频率
//#define SPEED_SAMPLING_FREQ (uint16_t)(10000/(SPEED_SAMPLING_TIME+1)) //1000hz
